...
const watchFiles = () => {
	// Assets.
	gulp.watch([dev + "images/**/*"], gulp.series(assets));
	// Images.
	gulp.watch(
	...
	// Fonts connection styles.
	gulp.watch([dev + "styles/fonts/*.styl"], gulp.series(fontStyles));
	// CSS.
